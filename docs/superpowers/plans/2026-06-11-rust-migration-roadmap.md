...
- Release installer self-check now accepts expected `bootstrap-tools` and wheelhouse platforms, rejecting mismatched
  runtime archive or Python wheelhouse payloads before artifacts are uploaded.
